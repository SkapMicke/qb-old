...
Config.DoorList = {
	...
	-- Prison Door 1
	{
		...
		objCoords  = vector3(1844.91, 2604.34, 45.58),
		textCoords = vector3(1844.91, 2604.34, 45.58),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 3
	...
	-- To Offices
	{
		objName = 'v_ilev_gtdoor',
		objYaw = 60.0,
		objCoords  = vec3(1832.64, 2526.01, 55.34),
		textCoords = vec3(1832.64, 2526.01, 55.34),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 2.0
	...
	-- To CrimChangingroom
	{
		objName = 'v_ilev_gtdoor',
		objYaw = 90.0,
		objCoords  = vec3(1826.88, 2586.01, 45.95),
		textCoords = vec3(1826.88, 2586.01, 45.95),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0
	...
	-- Checking Gate
	{
		objName = 'v_ilev_gtdoor',
		objYaw = 270.0,
		objCoords  = vec3(1837.93, 2594.6, 45.95),
		textCoords = vec3(1837.93, 2594.6, 45.95),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5

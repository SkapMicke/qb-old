...
Config.FinanceZone = vector3(113.79, -140.19, 54.86)-- Where the finance menu is located
...
Config.Shops = {
    ['pdm'] = {
        ...
        ['Zone'] = {
            ...
            vector2(96.891387939453, -155.37403869629),
            vector2(96.891387939453, -155.37403869629),
            vector2(151.38269042969, -175.91397094727),
            vector2(169.90287780762, -130.52964782715),
            vector2(103.85525512695, -107.55242156982)
            },
            ['minZ'] = 50.0, -- min height of the shop zone
        ...
        ['ShowroomVehicles'] = {
            ...
            [2] = {
                coords = vector4(126.76, -156.87, 53.75, 334.22),
                defaultVehicle = 'bmci',
                chosenVehicle = 'bmci'
            },
            [3] = {
                coords = vector4(134.07, -160.6, 53.75, 332.88),
                defaultVehicle = 'sq72016',
                chosenVehicle = 'sq72016'
            },
            [4] = {
                coords = vector4(142.08, -163.01, 62.75, 330.35),
                defaultVehicle = 'laferrari',
                chosenVehicle = 'laferrari'
            },
            [5] = {
                coords = vector4(118.58, -153.39, 59.72, 321.07),
                defaultVehicle = 'lambose',
                chosenVehicle = 'lambose'
            },
            [6] = {
                coords = vector4(142.17, -163.22, 53.74, 334.24),
                defaultVehicle = 'rs6',
                chosenVehicle = 'rs6'
            },
            [7] = {
                coords = vector4(134.37, -160.05, 54.37, 154.31),
                defaultVehicle = 'rs72020',
                chosenVehicle = 'rs72020'
            },
            [8] = {
                coords = vector4(953.9, 69.16, 75.82, 196.03),

...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["vehicle"] = {
        [1] = vector4(316.54, -553.46, 28.74, 269.19),
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
	...
	[0] = {
		["ambulance1"] = "Ambulans",
        ["ambulance2"] = "Ambulans Van",
        ["ambulance3"] = "Volvo Ambulans",
        ["ambulance4"] = "Mercedez Vito Ambulans",
        ["ambulance5"] = "Volvo Ambulans 2",
        ["ambulance6"] = "Mercedez Sprinter Ambulans",
        ["ambulance7"] = "Volvo V70 Akutläkare",
        ["ambulance12"] = "JourLäkare",
        ["ambulance15"] = "Mercedez Vito Akutläkare",
	},
	-- Grade 1
	[1] = {
		["ambulance1"] = "Ambulans",

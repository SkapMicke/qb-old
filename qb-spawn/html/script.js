...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Vart skulle du vilja vakna?"><p><span id="null">Vart skulle du vilja vakna?</span></p></div>')
